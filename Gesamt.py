...
class Dataloader(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # zurückgeben. Da hier das Netz nur angewwendet und nicht trainiert wird, werden diese Label
...
if __name__ == "__main__":
    ...
    for idx in range(len(os.listdir(bilderp))):
        ...
        cordslist = get_Ampfer_Cords(pic_name[:-4], boxes, bilderp)
